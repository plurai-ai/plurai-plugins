...
1. Ask the user (in chat) to paste their Plurai API key. Tell them they can get one from https://pluto.plurai.ai. Warn that the key will appear in this conversation.
