...
// well-formed JWT with a numeric, future-dated `exp` claim. Caller should
// refuse to forward the token if this returns null — a token whose exp can't
// be parsed is either malformed or already expired and should not be planted
// in browser history.
