...
Create an API key at https://app.plurai.ai/settings?tab=api-keys (click **Create new key**), then in Claude Code:

```
/evals:login
```

Paste the key when prompted. You only need to do this once per machine.
